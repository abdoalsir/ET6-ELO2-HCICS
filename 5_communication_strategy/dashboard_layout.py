...
def render_header():
    ...
    logo_content = (
        f"""
        <img src="{logo_src}" alt="Project Logo"
             style="width: {HEADER_LOGO_SIZE}px; height: {HEADER_LOGO_SIZE}px; border-radius: 50%; object-fit: cover; background: white;">
    """
        if logo_src
        else f"""
        <div style="width: {HEADER_LOGO_SIZE}px; height: {HEADER_LOGO_SIZE}px; border-radius: 50%; background-color: #3b82f6; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem;">{LOGO_FALLBACK_TEXT}</div>
    """
    )
    ...
    ">
        ...
        <div style="flex-shrink: 1; min-width: 0;">
            <h1 style="color: #1e40af; margin-bottom: 0.25rem; font-size: 2.2rem; font-weight: 700; white-space: nowrap;">
                HCICS Dashboard
            </h1>
            <p style="color: #475569; font-size: 1.1rem; margin-top: 0; margin-bottom: 0.5rem; font-weight: 500;">
                Humanitarian Crisis Intelligence & Communication System
            </p>
            <p style="color: #64748b; font-size: 0.9rem; margin-top: 0; margin-bottom: 0;">
...
def render_footer():
    ...
    """
        ...
        <div style="width: 60px; height: 60px; border-radius: 50%; background-color: white; display: flex; align-items: center; justify-content: center; color: #1e3a8a; font-size: 1.25rem;">{LOGO_FALLBACK_TEXT}</div>
    """
    )
