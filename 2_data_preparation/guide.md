...
1. Read in datasets from `1_datasets`
2. Clean, reformat, or otherwise process the datasets for later.
3. Write the processed dataset into `1_datasets` with a helpful file name.

**DO NOT modify an existing dataset in `1_datasets`! Instead, save your
